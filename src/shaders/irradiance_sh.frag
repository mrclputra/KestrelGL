...
void main() {
    ...
    // These come from the A_l coefficients (how much each frequency contributes)
    ...
    // Evaluate the SH-based irradiance (equation 13 from paper)
    // This is just a quadratic polynomial in x,y,z!
    vec3 irradiance = 
