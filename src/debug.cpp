...
static void loadScene01(Scene& scene) {
	...
	// OBJECTS
	auto sphere0 = ModelLoader::load("assets/models/cubeSphere.obj", scene.textures);
	...
	auto sphere1 = ModelLoader::load("assets/models/cubeSphere.obj", scene.textures);
	...
	auto sphere2 = ModelLoader::load("assets/models/cubeSphere.obj", scene.textures);
	...
	auto dragon = ModelLoader::load("assets/models/stanford_dragon_pbr/scene.gltf", scene.textures);
